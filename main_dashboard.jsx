...
export default function DashboardBW() {
  return (
    <div className="min-h-screen w-full bg-black text-white flex flex-col items-center px-4 py-8">
      ...
      {/* Main Card Grid */}
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-3 gap-10 mb-12">
        {/* Trending Post */}
        <div className="bg-[#18181b] border border-white/10 rounded-2xl shadow-lg flex flex-col p-7 animate-fade-in">
        ...
        {/* Content Score */}
        <div className="bg-[#18181b] border border-white/10 rounded-2xl shadow-lg flex flex-col items-center justify-center p-7 animate-fade-in">
        ...
        {/* Quick Stats */}
        <div className="bg-[#18181b] border border-white/10 rounded-2xl shadow-lg flex flex-col p-7 gap-y-5 animate-fade-in">
